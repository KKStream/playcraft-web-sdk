...
const onViewModeChange = (video, onChange) => {
  ...
  const registered = [
    on(video, 'webkitbeginfullscreen', () => onChange('fullscreen')),
    on(video, 'webkitendfullscreen', () => onChange('inline')),
  ]
  return () => {
...
const subscribePlaybackState = (media, updateState) => {
  ...
  const registered = [
    ...
    on(media, 'loadstart', event => updateIfChanged(event, 'loading')),
...
const FunctionBarExtension = ({children}) => {
  ...
  return slots !== null && slots !== void 0 && slots.functionBar
    ? /*#__PURE__*/ createPortal(children, slots.functionBar)
    : ''
}
...
const loadPlayer = async (
  videoElement,
  {container, autoplay, source, shaka, bitmovin}
) => {
  ...
  return /*#__PURE__*/ jsx(IntlProvider, {
    ...
    children: /*#__PURE__*/ jsxs$1(DefaultLayout, {
      ...
      children: [
        ...
        waiting && /*#__PURE__*/ jsx(LoadingSpinner, {}),
...
const PlayDialog = ({
  ...
  const {observe, currentBreakpoint: size} = useDimensions({
    polyfill: ResizeObserver,
    breakpoints: {
      normal: 0,
      big: 600,
...
const AutoplayPrompt = ({
  ...
  useEffect(() => {
    ...
    return on(videoRef.current, 'timeupdate', () =>
      updateChapter({
        endStart,
      })
    )
  ...
  return /*#__PURE__*/ jsxs$1(PremiumPlayer, {
    ...
    onPlaybackStateChange: (event, state) => {
      ...
      if (state === 'error') {
        ...
        ;(_lastSession$current$ = (_lastSession$current2 = lastSession.current)
          .end) === null || _lastSession$current$ === void 0
          ? void 0
          : _lastSession$current$.call(_lastSession$current2)
        lastSession.current = {}
      }
      ...
      if (
        ...
        ;(_lastSession$current$2 = (_lastSession$current3 = lastSession.current)
          .updateLastPlayed) === null || _lastSession$current$2 === void 0
          ? void 0
          : _lastSession$current$2.call(_lastSession$current3)
      }
...
const Seekbar = () => {
  ...
  const {
    ...
    ? getLivesInfo(_get(state, 'customData') || {})
    : state
  return jsxs('div', {
    className: 'kks-player__seek-bar',
    css: _ref,
    ...
    jsx$1('div', {
      ...
      children: isIdle
        ...
        : jsxs(FunctionBar, {
            style: controlStyle,
            children: [
              !isPlayingBreak && jsx$1(Seekbar, {}),
              jsx$1(PreviousEpisodeButton, {}),
              jsx$1(PlayButton, {}),
              jsx$1(NextEpisodeButton, {}),
              isPlayingBreak
                ? jsxs('div', {
                    css: adStatusStyle,
                    children: [
                ...
                : jsxs(Fragment, {
                    children: [
                      streamType !== 'LIVE' && jsx$1(RewindButton, {}),
                      streamType !== 'LIVE' && jsx$1(ForwardButton, {}),
                      jsx$1(Tooltip, {
                        overflowOnly: true,
...
const VideoPlayer = ({
  ...
  useEffect(() => {
    const unsubscribe = subscribeMediaState(
      videoProps.videoRef.current,
      setVideoState,
      videoProps.plugins
    )
    return () => unsubscribe()
  ...
  const uiProps = {
    ...
    onPlaybackStateChange: playbackState =>
      setTargetState(state => ({...state, playbackState})),
    onCurrentTimeChange: currentTime =>
      setTargetState(state => ({...state, currentTime})),
  }
  return jsx$1(IntlProvider, {
    children: jsx$1(BasicUi, {
      video: jsx$1(Video, {...videoProps, ...targetState}),
      ...videoState,
      ...uiProps,
      children: children,
    }),
